...
$root.circle.AssociatedFileType = {
    UNKNOWN: 0,
    DESCRIPTIONS: 1,
...
$root.circle.AssociatedFile = class AssociatedFile {

    static decode(reader, position) {
        const $ = new $root.circle.AssociatedFile();
        $.name = reader.string_(position, 4, null);
...
$root.circle.FeatureProperties = class FeatureProperties {

    static decode(/* reader, position */) {
        const $ = new $root.circle.FeatureProperties();
        return $;
    }
};

$root.circle.ColorSpaceType = {
    UNKNOWN: 0,
    RGB: 1,
    GRAYSCALE: 2
};

$root.circle.ImageSize = class ImageSize {

    static decode(reader, position) {
        const $ = new $root.circle.ImageSize();
...
$root.circle.ImageProperties = class ImageProperties {

    static decode(reader, position) {
        const $ = new $root.circle.ImageProperties();
        $.color_space = reader.int8_(position, 4, 0);
        $.default_size = reader.table(position, 6, $root.circle.ImageSize.decode);
        return $;
    }
};

$root.circle.BoundingBoxType = {
    UNKNOWN: 0,
    BOUNDARIES: 1,
    UPPER_LEFT: 2,
    CENTER: 3
...
$root.circle.CoordinateType = {
    RATIO: 0,
    PIXEL: 1
};

$root.circle.BoundingBoxProperties = class BoundingBoxProperties {

    static decode(reader, position) {
        const $ = new $root.circle.BoundingBoxProperties();
...
$root.circle.ContentProperties = class {

    static decode(reader, position, type) {
        switch (type) {
            case 1: return $root.circle.FeatureProperties.decode(reader, position);
            case 2: return $root.circle.ImageProperties.decode(reader, position);
            case 3: return $root.circle.BoundingBoxProperties.decode(reader, position);
        }
        return undefined;
    }
    ...
    static decodeText(reader, json, type) {
        switch (type) {
            case 'FeatureProperties': return $root.circle.FeatureProperties.decodeText(reader, json);
            case 'ImageProperties': return $root.circle.ImageProperties.decodeText(reader, json);
            case 'BoundingBoxProperties': return $root.circle.BoundingBoxProperties.decodeText(reader, json);
        }
        return undefined;
    }
};

$root.circle.ValueRange = class ValueRange {

    static decode(reader, position) {
        const $ = new $root.circle.ValueRange();
...
$root.circle.Content = class Content {

    static decode(reader, position) {
        const $ = new $root.circle.Content();
        $.content_properties = reader.union(position, 4, $root.circle.ContentProperties.decode);
        $.range = reader.table(position, 8, $root.circle.ValueRange.decode);
        return $;
    }
};

$root.circle.NormalizationOptions = class NormalizationOptions {

    static decode(reader, position) {
        const $ = new $root.circle.NormalizationOptions();
...
$root.circle.ScoreTransformationType = {
    IDENTITY: 0,
    LOG: 1,
    INVERSE_LOGISTIC: 2
};

$root.circle.ScoreCalibrationOptions = class ScoreCalibrationOptions {

    static decode(reader, position) {
        const $ = new $root.circle.ScoreCalibrationOptions();
...
$root.circle.ScoreThresholdingOptions = class ScoreThresholdingOptions {

    static decode(reader, position) {
        const $ = new $root.circle.ScoreThresholdingOptions();
        $.global_score_threshold = reader.float32_(position, 4, 0);
        return $;
    }
};

$root.circle.BertTokenizerOptions = class BertTokenizerOptions {

    static decode(reader, position) {
        const $ = new $root.circle.BertTokenizerOptions();
        $.vocab_file = reader.tableArray(position, 4, $root.circle.AssociatedFile.decode);
        return $;
    }
};

$root.circle.SentencePieceTokenizerOptions = class SentencePieceTokenizerOptions {

    static decode(reader, position) {
        const $ = new $root.circle.SentencePieceTokenizerOptions();
        $.sentencePiece_model = reader.tableArray(position, 4, $root.circle.AssociatedFile.decode);
        $.vocab_file = reader.tableArray(position, 6, $root.circle.AssociatedFile.decode);
        return $;
    }
};

$root.circle.RegexTokenizerOptions = class RegexTokenizerOptions {

    static decode(reader, position) {
        const $ = new $root.circle.RegexTokenizerOptions();
...
$root.circle.ProcessUnitOptions = class {

    static decode(reader, position, type) {
        switch (type) {
            case 1: return $root.circle.NormalizationOptions.decode(reader, position);
            case 2: return $root.circle.ScoreCalibrationOptions.decode(reader, position);
            case 3: return $root.circle.ScoreThresholdingOptions.decode(reader, position);
            case 4: return $root.circle.BertTokenizerOptions.decode(reader, position);
            case 5: return $root.circle.SentencePieceTokenizerOptions.decode(reader, position);
            case 6: return $root.circle.RegexTokenizerOptions.decode(reader, position);
        }
        return undefined;
    }
    ...
    static decodeText(reader, json, type) {
        switch (type) {
            case 'NormalizationOptions': return $root.circle.NormalizationOptions.decodeText(reader, json);
            case 'ScoreCalibrationOptions': return $root.circle.ScoreCalibrationOptions.decodeText(reader, json);
            case 'ScoreThresholdingOptions': return $root.circle.ScoreThresholdingOptions.decodeText(reader, json);
            case 'BertTokenizerOptions': return $root.circle.BertTokenizerOptions.decodeText(reader, json);
            case 'SentencePieceTokenizerOptions': return $root.circle.SentencePieceTokenizerOptions.decodeText(reader, json);
            case 'RegexTokenizerOptions': return $root.circle.RegexTokenizerOptions.decodeText(reader, json);
        }
        return undefined;
    }
};

$root.circle.ProcessUnit = class ProcessUnit {

    static decode(reader, position) {
        const $ = new $root.circle.ProcessUnit();
        $.options = reader.union(position, 4, $root.circle.ProcessUnitOptions.decode);
        return $;
    }
};

$root.circle.Stats = class Stats {

    static decode(reader, position) {
        const $ = new $root.circle.Stats();
...
$root.circle.TensorGroup = class TensorGroup {

    static decode(reader, position) {
        const $ = new $root.circle.TensorGroup();
        $.name = reader.string_(position, 4, null);
...
$root.circle.TensorMetadata = class TensorMetadata {

    static decode(reader, position) {
        const $ = new $root.circle.TensorMetadata();
        $.name = reader.string_(position, 4, null);
        $.description = reader.string_(position, 6, null);
        $.dimension_names = reader.strings_(position, 8);
        $.content = reader.table(position, 10, $root.circle.Content.decode);
        $.process_units = reader.tableArray(position, 12, $root.circle.ProcessUnit.decode);
        $.stats = reader.table(position, 14, $root.circle.Stats.decode);
        $.associated_files = reader.tableArray(position, 16, $root.circle.AssociatedFile.decode);
        return $;
    }
};

$root.circle.SubGraphMetadata = class SubGraphMetadata {

    static decode(reader, position) {
        const $ = new $root.circle.SubGraphMetadata();
        $.name = reader.string_(position, 4, null);
        $.description = reader.string_(position, 6, null);
        $.input_tensor_metadata = reader.tableArray(position, 8, $root.circle.TensorMetadata.decode);
        $.output_tensor_metadata = reader.tableArray(position, 10, $root.circle.TensorMetadata.decode);
        $.associated_files = reader.tableArray(position, 12, $root.circle.AssociatedFile.decode);
        $.input_process_units = reader.tableArray(position, 14, $root.circle.ProcessUnit.decode);
        $.output_process_units = reader.tableArray(position, 16, $root.circle.ProcessUnit.decode);
        $.input_tensor_groups = reader.tableArray(position, 18, $root.circle.TensorGroup.decode);
        $.output_tensor_groups = reader.tableArray(position, 20, $root.circle.TensorGroup.decode);
        return $;
    }
};

$root.circle.ModelMetadata = class ModelMetadata {
    ...
    static create(reader) {
        return $root.circle.ModelMetadata.decode(reader, reader.root);
    }

    static decode(reader, position) {
        const $ = new $root.circle.ModelMetadata();
        $.name = reader.string_(position, 4, null);
        $.description = reader.string_(position, 6, null);
        $.version = reader.string_(position, 8, null);
        $.subgraph_metadata = reader.tableArray(position, 10, $root.circle.SubGraphMetadata.decode);
